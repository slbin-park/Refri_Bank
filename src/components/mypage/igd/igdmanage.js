                ...
                <div className='igd_body_color'>
                                            ...
                                            <div className='igd_box_1_content'>
                                                {igd_info && igd_info.length > igd_slice.start && igd_info != undefined ?
                                                    <div className="igd_box_img_form">
                                                        ...
                                                        <br />{igd_info[igd_slice.start].result_igdname}<br />
                                                        {igd_info[igd_slice.start].eprd}<br />
                                                D {igd_info[igd_slice.start].eprd_remain}<br />
                                                    </div> : ''}
                                            ...
                                            <div className='igd_box_1_content'>
                                                {igd_info && igd_info.length > igd_slice.start + 1 && igd_info != undefined ?
                                                    <div className="igd_box_img_form">
                                                        ...
                                                        <br />{igd_info[igd_slice.start + 1].result_igdname}<br />
                                                        {igd_info[igd_slice.start + 1].eprd}<br />
                                                D {igd_info[igd_slice.start + 1].eprd_remain}<br />
                                                    </div> : ''}
                                        ...
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 2 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 2].result_igdname}<br />
                                                    {igd_info[igd_slice.start + 2].eprd}<br />
                                                D {igd_info[igd_slice.start + 2].eprd_remain}<br />
                                                </div> : ''}
                                        ...
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 3 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 3].result_igdname}<br />
                                        ...
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 9 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 9].result_igdname}<br />
                                                    {igd_info[igd_slice.start + 9].eprd}<br />
                                        ...
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 10 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 10].result_igdname}<br />
                                                    {igd_info[igd_slice.start + 10].eprd}<br />
                                                D {igd_info[igd_slice.start + 10].eprd_remain}<br />
                                                </div> : ''}
                                        </div>
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 11 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 11].result_igdname}<br />
                                                    {igd_info[igd_slice.start + 11].eprd}<br />
                                                D {igd_info[igd_slice.start + 11].eprd_remain}<br />
                                                </div> : ''}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 12 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 12].result_igdname}<br />
                                                    {igd_info[igd_slice.start + 12].eprd}<br />
                                                D {igd_info[igd_slice.start + 12].eprd_remain}<br />
                                                </div> : ''}
                                        </div>
                                        <div className='igd_box_top1_img'>
                                            {igd_info && igd_info.length > igd_slice.start + 13 && igd_info != undefined ?
                                                <div >
                                                    ...
                                                    <br />{igd_info[igd_slice.start + 13].result_igdname}<br />
                                                    {igd_info[igd_slice.start + 13].eprd}<br />
                    ...
                    <div style={{ display: 'flex', 'justify-content': 'center', 'align-items': 'center' }}>
                        <div className="like_select_num_btn_form">
                            {<Igd_button ftable_cnt={igd_btn} set_page_slice={set_igd_slice} />}
                        </div>
                    </div>
