        ...
        <div className="introduce-big-box">
                ...
                <div className="left-big-box">
                    ...
                    <div className="left-second-box">
                        <div className="front-end-box">
                            ...
                            <img src={react_img} width="40" height="40"></img>
                            <img src={html_img} width="40" height="50"></img>
                            <img src={css_img} width="40" height="50"></img>
                        </div>
                        <div className="back-end-box">
                            <li><ul> •back-end</ul></li>
                            <img src={node_img} width="45" height="45"></img>
                            <img src={mysql_img} width="75" height="55"></img>
                            <img src={express_img} width="100" height="40"></img>
                        </div>
            ...
            <div className="introduce-bottom-box">
                <div className="introduce-bottom-left">  
                    ...
                    <img className="third-box-img1" src={logo2} width='140' height='70'></img>
                    <img className="third-box-img2" src={logo3} width='160' height='70'></img>  
                </div> 
                <div className="introduce-bottom-right"> 
                    {/* <button onClick={Func_move_up}><img src={move_top_btn} width="40" height="40"></img></button> */}
                    <button className="introduce-bottom-right-btn"><img src={move_top_btn} width="60" height="60"></img></button>
                </div> 
            </div>
        </div>
    )
